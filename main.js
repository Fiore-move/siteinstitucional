    ...
    arduino.pipe(new serialport.ReadlineParser({ delimiter: '\r\n' })).on('data', async (data) => {
        ...
        if (HABILITAR_OPERACAO_INSERIR) {
            if (AMBIENTE == 'producao') {
                ...
                sqlquery = `INSERT INTO statusSENSORS (fkSensor,umidade, temperatura) VALUES (10,${dht11Umidade}, ${dht11Temperatura})`;
                ...
                await poolBancoDados.execute(
                    'INSERT INTO sensor (fkEmpresa,umidade, temperatura) VALUES (?, ?, ?, ?, ?, now(), 1)',
